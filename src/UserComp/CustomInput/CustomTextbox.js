...
function CustomTextbox({changeText, obj, last, next, submit}) {
    return (
        <div className='layout-one__right__answer'>
            <div className='textbox'>
                <input type='text' defaultValue={obj.answer[obj.activeQuestion]} placeholder='Type your answer hear...' className='ant-input' onChange={changeText} />
            </div>
